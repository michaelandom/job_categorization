...
warnings.filterwarnings(
    "ignore", message="Some weights of RoBERTaForSequenceClassification were not initialized")
...
class RoBERTaTrainer:
    ...
    def train_model(self):
        logger.info("Starting RoBERTa model training...")
        ...
        val_dataset = RoBERTaDataset(X_val, y_val, tokenizer, self.max_length)
